...
import sandbox.editor.commands.*;
...
public class Main extends JPanel implements ActionListener {
    ...
    public enum ToolMode { DRAG, PLACE, DELETE, SHOOT, CONFIGURE, LINK, PRISMATIC, DRAW }
    
    public enum SpawnType { 
        PHYSICS_STEEL_CUBE, PHYSICS_WOOD_TRI, PHYSICS_RUBBER_BALL, PHYSICS_GLASS, PHYSICS_SOFT_CIRCLE,
                        ...
                        case PRISMATIC -> {
                            if (clickedBall != null && clickedBall != activePlayer) {
                                if (linkStartNode == null) linkStartNode = clickedBall;
                                    ...
                                    Vector2D axis = worldClick.subtract(linkStartNode.getPosition()).normalize();
                                    CommandHistory.executeCommand(new JointCommand(engine, new PrismaticJoint(linkStartNode, clickedBall, worldClick, axis)));
                                    linkStartNode = null;
                                }
                            } else linkStartNode = null;
                        }
    ...
    private void spawnEntity(Vector2D pos) {
        ...
        switch (currentSpawn) {
            ...
            case PHYSICS_SOFT_CIRCLE -> { SoftBodyFactory.createSoftCircle(engine, pos.x, pos.y, 60, 8, Material.WOOD); return; }
        ...
        addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(KeyEvent e) {
                ...
                switch (e.getKeyCode()) {
                    ...
                    case KeyEvent.VK_6 -> { currentMode = ToolMode.PRISMATIC; wireStartNode = null; linkStartNode = null; customShapePoints.clear(); }
                    case KeyEvent.VK_7 -> { currentMode = ToolMode.DRAW; wireStartNode = null; linkStartNode = null; customShapePoints.clear(); }
    ...
    protected void paintComponent(Graphics g) {
        ...
        if ((currentMode == ToolMode.LINK || currentMode == ToolMode.PRISMATIC) && linkStartNode != null) {
        ...
        g2d.setColor(currentMode == ToolMode.PRISMATIC ? DYNAMIC_COLOR : Color.GRAY);g2d.drawString("[6] PRISMATIC (Click 2 for piston-link)", 20, y); y += 20;
        g2d.setColor(currentMode == ToolMode.DRAW ? DYNAMIC_COLOR : Color.GRAY);     g2d.drawString("[7] DRAW SHAPE (Right-click to finish)", 20, y); y += 30;
